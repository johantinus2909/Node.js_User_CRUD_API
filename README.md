...
Lakukan perubahan dan commit (git commit -am 'Add new feature').
Push perubahan Anda ke fork (git push origin feature-branch).
...
Berikut adalah file `.env.example` yang bisa Anda sertakan dalam repository sebagai referensi untuk konfigurasi variabel lingkungan yang dibutuhkan:
...
DB_USER=root                # Ganti dengan username MySQL Anda
DB_PASSWORD=your-password    # Ganti dengan password MySQL Anda
DB_NAME=user_management      # Gunakan nama database yang sama seperti di atas
